    ...
    <script>
     ...
     <div class='container horizontal-layout'>
         <div class='horizontal-inline'>
             <h1>Small Talk</h1>
             <asp:Button ID="CreateBtn" class="button green" runat="server" Text="Create"/>
             <asp:Button ID="JoinBtn" class="button blue" runat="server" Text="Join"/>
         </div>
         <div class='horizontal-inline'>
         ...
         <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender1" runat="server" OkControlID="Cancel" PopupControlID="Panel1" TargetControlID="CreateBtn" BackgroundCssClass="modalBackground">
